...
/**
 * {@link Transformer} instance which converts a {@link Blob} to a {@link String}.
 * <p/>
 ...
 * @since solr 1.4
 */
public class BlobTransformer2 extends Transformer {
  @Override
  public Object transformRow(Map<String, Object> aRow, Context context) {
    for (Map<String, String> map : context.getAllEntityFields()) {
      if (!TRUE.equals(map.get(BLOB))) continue;
  ...
  private String readFromBlob(Blob blob) {
    Reader reader = FieldReaderDataSource.getReader(blob);
